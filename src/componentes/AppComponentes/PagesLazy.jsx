...
const PAGES_LAZY = [
  ...
  { key: 'MERCHANDISING', path: '/merchandising', label: 'Merchandising', component: lazy(() => import('../paginas-principales/MerchanPag')) },
  { key: 'CONTACTO', path: '/contacto', label: 'Contacto', component: lazy(() => import('../paginas-principales/ContactoPag')) },
