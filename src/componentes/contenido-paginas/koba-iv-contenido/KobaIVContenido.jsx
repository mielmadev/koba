      ...
      <div className="cartel-koba">
        <div className="nivel-1">
          <div className="banda-contenedor" data-nombre="Eclipse">
            <Link
              to={getBanda("Eclipse").link}
              tabIndex={0}
              aria-label="Ver página de Eclipse"
              className="banda-link"
            >
              <img
                src={getBanda("Eclipse").imagen}
                alt="Eclipse"
                loading="lazy"
        ...
        <div className="nivel-2">
          <div className="banda-contenedor" data-nombre="Wolfheart">
            <Link
              to={getBanda("Wolfheart").link}
              tabIndex={0}
              aria-label="Ver página de Wolfheart"
              className="banda-link"
            >
              <img
        ...
        <div className="nivel-3">
          <div className="banda-contenedor" data-nombre="Asgarth">
            <Link
              to={getBanda("Asgarth").link}
              tabIndex={0}
              aria-label="Ver página de Asgarth"
              className="banda-link"
            >
              <img
                src={getBanda("Asgarth").imagen}
                alt="Asgarth"
                loading="lazy"
                className="banda-imagen"
              />
          ...
          <div className="banda-contenedor" data-nombre="Ehun Kilo">
            <Link
              to={getBanda("Ehun Kilo").link}
              tabIndex={0}
              aria-label="Ver página de Ehun Kilo"
              className="banda-link"
            >
              <img
                src={getBanda("Ehun Kilo").imagen}
                alt="Ehun Kilo"
                loading="lazy"
                className="banda-imagen"
              />
          ...
          <div className="banda-contenedor" data-nombre="Before The Dawn">
            <Link
              to={getBanda("Before The Dawn").link}
              tabIndex={0}
              aria-label="Ver página de Before The Dawn"
              className="banda-link"
            >
              <img
                src={getBanda("Before The Dawn").imagen}
                alt="Before The Dawn"
                loading="lazy"
                className="banda-imagen"
              />
        ...
        <div className="nivel-4">
          <div className="banda-contenedor" data-nombre="The Electric Alley">
            <Link
              to={getBanda("The Electric Alley").link}
              tabIndex={0}
              aria-label="Ver página de The Electric Alley"
              className="banda-link"
            >
              <img
                src={getBanda("The Electric Alley").imagen}
                alt="The Electric Alley"
                loading="lazy"
                className="banda-imagen"
              />
            </Link>
          ...
          <div className="banda-contenedor" data-nombre="Moonshinerds">
            <Link
              to={getBanda("Moonshinerds").link}
              tabIndex={0}
              aria-label="Ver página de Moonshinerds"
              className="banda-link"
            >
              <img
                src={getBanda("Moonshinerds").imagen}
                alt="Moonshinerds"
                loading="lazy"
                className="banda-imagen"
              />
