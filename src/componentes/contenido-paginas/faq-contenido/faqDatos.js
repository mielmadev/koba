...
const faqDatos = {
  es: [
    ...
    {
      id: "accesibilidad",
      pregunta: "¿El recinto es accesible para cualquier público metalero?",
      respuesta:
        "¡Por supuesto! El acceso está preparado para que cualquier guerrero del metal pueda entrar en silla de ruedas sin problema. Aquí nadie se queda fuera del mosh pit."
    },
    {
      id: "comida",
