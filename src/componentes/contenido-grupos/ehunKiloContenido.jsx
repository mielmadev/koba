...
const ehunKiloContenido = () => {
  const banda = bandasDatos2025.find((b) => b.nombre === "Ehun Kilo");
          ...
          <div className="grupo-encabezado-superior">
            ...
            <div className="grupo-encabezado-superior-derecha">
              <div className="grupo-estilo">
                {banda.estilo} - {banda.anio}
              </div>
              <div className="grupo-origen">
                {banda.origen.pais} - {banda.origen.provincia} -{" "}
                {banda.origen.ciudad}
              </div>
            </div>
          </div>
...
export default ehunKiloContenido;
