  ...
  return (
    <div className="about-contenedor">
      ...
      <div className='about-h2'>
        Hay 3 palabras que definen al equipo del Koba Live: honestidad, pasión y corazón.
      </div>

      <div className='about-texto'>
        Suponemos que nuestra historia no es diferente a la de otros, pero es la nuestra y la llevamos por bandera con mucho orgullo.
      ...
      <div className='about-texto'>
        Al ponernos manos a la obra, tenemos claro que, cada edición, queremos cumplir contigo una promesa:
      </div>

      <div className='about-h3'>
        Que respires, vivas y experimentes el verdadero metal
      </div>

      <div className='about-texto'>
        Y nuestro entorno nos lo permite.
      ...
      <div className='about-video'>
        <iframe width="812" height="457" src="https://www.youtube.com/embed/Bq7QldlGt2U" title="Mini-documental KOBA LIVE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
